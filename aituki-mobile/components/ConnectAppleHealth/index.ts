/**
 * Connect Apple Health – Screen components
 * Figma 173-30875 / 173-31263
 */

export { default as ConnectAppleHealthHeader } from './ConnectAppleHealthHeader';
...
export { default as ConnectAppleHealthActions } from './ConnectAppleHealthActions';
